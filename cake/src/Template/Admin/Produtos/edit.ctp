    ...
    <div class="ls-box-filter">
        ...
        <div class="ls-box_ ls-equal-height-box-2">
            ...
            <div id="webdesk-form">
                ...
                <div class="images">
                    <label>
                        <div class="ls-prefix-group"><span class="ls-label-text-prefix">Fotos já cadastradas</span>
                    <?PHP foreach($produto->imgprodutos as $image){ ?>
                        <li><?PHP echo $this->Html->image('../files/imgprodutos/photo/'.$image->photo_dir.'/square_'.$image->photo) ?><?PHP echo $this->Html->link('deletar imagem','/admin/imgprodutos/delete/'.$image->id) ?></li>
                    <?PHP } ?>
                            </div>
                    </label>
                </div>
