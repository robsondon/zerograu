<div class="container-fluid">
    ...
    <div class="ls-box-filter">
        <h2 class="ls-title-2">Produtos<span style="font-size: calc(100% - 40%);"> / listagem</span></h2>
        ...
        <?php foreach ($produtos as $produto): ?>
            <tr>
                ...
                <td class="ls-txt-right ls-regroup">
                    <?= $this->Html->link('Visualizar','/produtos/'.$produto->id, ['target'=>'blank','class' => 'ls-btn ls-btn-xs']); ?>

                    <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
                        <a href="#" class="ls-btn ls-btn-xs" role="combobox" aria-expanded="false"></a>
                        <ul class="ls-dropdown-nav" aria-hidden="true">

                            <li><?= $this->Html->link(__('Editar'), array('action' => 'edit', $this->Number->format($produto->id))); ?></li>

                            <!--<li><a href="#" class="ls-color-danger" role="option">Excluir nocake</a></li>-->

                            <li><?= $this->Form->postLink(__('Deletar'), ['action' => 'delete', $produto->id], ['class' => 'ls-color-danger', 'role' => 'option', 'confirm' => __('Você tem certeza de que deseja excluir o registro: # {0}?', $produto->id)]) ?></li>
